  ...
  return (
    <div id="wd-kanbas-navigation" style={{width:115}}
      ...
      <Link to="/Kanbas/Calendar" id="wd-calendar-link"
        className="list-group-item text-white
                   bg-black text-center border-0">
          <FaRegCalendarAlt className="fs-1 text-danger"/><br />Calendar</Link>

      <Link to="/Kanbas/Inbox" id="wd-inbox-link"
        className="list-group-item text-white
                   bg-black text-center border-0" > 
          <IoMailOpenOutline className="fs-1 text-danger"/><br />Inbox</Link>

      <Link to="/Labs" id="wd-labs-link"
        className="list-group-item text-white
                   bg-black text-center border-0" >
           <BsPersonWorkspace className="fs-1 text-danger"/><br />Labs</Link>
    </div>
);}
